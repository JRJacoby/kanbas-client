			...
			<div>
				...
				<div className="w-50">
					...
					<div>
						...
						<input id="access-code" className="form-control" value={quiz.accessCode} onChange={(e) => setQuizDetails({...quiz, accessCode: e.target.value})} />
					</div>

					<div className="form-check form-group">
						<label className="form-check-label" htmlFor="one-question-at-a-time">One Question at a Time</label>
						<input id="one-question-at-a-time" className="form-check-input" type="checkbox" checked={quiz.oneQuestionAtATime} onChange={(e) => setQuizDetails({...quiz, oneQuestionAtATime: e.target.checked})} />
					</div>

					<div className="form-check form-group">
						<label className="form-check-label" htmlFor="webcam-required">Webcam Required</label>
						<input id="webcam-required" className="form-check-input" type="checkbox" checked={quiz.webcamRequired} onChange={(e) => setQuizDetails({...quiz, webcamRequired: e.target.checked})} />
					</div>

					<div className="form-check form-group">
						<label className="form-check-label" htmlFor="lock-questions-after-answering">Lock Questions After Answering</label>
						<input id="lock-questions-after-answering" className="form-check-input" type="checkbox" checked={quiz.lockQuestionsAfterAnswering} onChange={(e) => setQuizDetails({...quiz, lockQuestionsAfterAnswering: e.target.checked})} />
					</div>
